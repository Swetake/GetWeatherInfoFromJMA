...
{
	/// <summary>
	///     GetWeatherInfoFromJMA AsyncTaskCodeActivity with result <T>
	/// </summary>
	public abstract class AsyncTaskCodeActivity<T> : AsyncCodeActivity, IDisposable
	{
		...
		protected override IAsyncResult BeginExecute(AsyncCodeActivityContext context, AsyncCallback callback, object state)
		{
			...
			var property = context.DataContext.GetProperties()[WeatherInfoScope.ParentContainerPropertyTag];
	...
	/// <summary>
	///     GetWeatherInfoFromJMA AsyncTaskCodeActivity without result
	/// </summary>
